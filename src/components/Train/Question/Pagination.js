...
class Pagination extends Component {
  ...
  passPagination = (page) => {
    var { store_code,  limit , courseId  } = this.props
    var params =`&limit=${limit}`
    this.props.fetchAllLesson(store_code ,courseId, page , params)    
}
  ...
  render() {
    var links = this.props.lessons.links || []
    return (
...
const mapDispatchToProps = (dispatch, props) => {
  return {
    ...
    fetchAllLesson: (store_code ,courseId ,page , params) => {
      dispatch(trainAction.fetchAllLesson(store_code , courseId, page , params));
    },
  };
};
