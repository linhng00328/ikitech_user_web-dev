...
class Modal extends Component {
  ...
  onSave = (e) => {
    ...
    var {id , train_course_id} = this.props.modal;
    var { store_code } = this.props
    this.props.destroyChapter(store_code, id ,train_course_id );
  };
...
const mapDispatchToProps = (dispatch, props) => {
  return {
    destroyChapter: (store_code, id ,train_course_id) => {
      dispatch(trainAction.destroyChapter(store_code, id , train_course_id));
    },
  };
};
