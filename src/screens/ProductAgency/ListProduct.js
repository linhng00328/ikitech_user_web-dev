...
class ListProduct extends Component {
  ...
  onSaveProduct = () => {
    ...
    const { exportProductAgency, store_code, level_agency, agency_type_id } =
      this.props;
  ...
  onChangeNumPage = (e) => {
    ...
    const { store_code, agency_type_id } = this.props;
    const branch_id = localStorage.getItem("branch_id");
    ...
    const params = this.getParams("", "", searchValue, numPage, agency_type_id);
    this.props.fetchAllProductV2(store_code, branch_id, 1, params);
  };
  getParams = (
    listType,
