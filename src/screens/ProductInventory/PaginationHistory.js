...
class Pagination extends Component {
  ...
  fetchAllDiscountEnd = (page) => {
    ...
    this.props.historyInventorys(store_code, formData, page);
  };
  ...
  render() {
    ...
    var links =
      typeof historyInventory.links !== "undefined"
        ? historyInventory.links
        : [];
    return (
      <nav
...
const mapDispatchToProps = (dispatch, props) => {
  return {
    historyInventorys: (store_code, data, page) => {
      dispatch(inventoryAction.historyInventorys(store_code, data, page));
    },
  };
};
